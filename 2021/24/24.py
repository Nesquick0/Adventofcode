...
def main():
    # From https://www.reddit.com/r/adventofcode/comments/rnejv5/comment/hqstr1a/?utm_source=share&utm_medium=web2x&context=3
    print(solve(read_puzzle("input.txt")))
    print(solve(read_puzzle("input.txt"), False))
